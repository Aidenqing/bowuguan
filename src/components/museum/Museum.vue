<template>
  <transition name="slide">
    <div class="museum">
      ...
      <div class="content">
        <scroll class="exhibits" v-show="currentIndex>0">
          <div>
      ...
      <div class="iframe" v-show="threeDLoding&&has3D">
      ...
      <img class="threeD" src="@/common/image/3d.png" alt="" v-show="has3D" @click="handle3D(true)">
    </div>
  </transition>
</template>
